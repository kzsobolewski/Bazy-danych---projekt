...
DELIMITER //
 CREATE or REPLACE PROCEDURE Liczenie_godzin(IN prac_id int, IN od_kiedy date, IN ilosc_dni int, OUT godziny int) -- Procedura wyliczajaca ilosc przepracowanych godzin dla konkretnego pracownika
   BEGIN
